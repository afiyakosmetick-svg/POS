...
const DEMO = [
  ['admin@afiacosmetics.shop', 'Afia Rahman', 'Business Owner'],
  ['manager@afiacosmetics.shop', 'Tania Islam', 'Manager'],
  ['cashier@afiacosmetics.shop', 'Rakib Hasan', 'Cashier'],
  ['inventory@afiacosmetics.shop', 'Sabbir Ahmed', 'Inventory Manager'],
  ['accounts@afiacosmetics.shop', 'Farhana Akter', 'Accountant'],
];
