...
export class Cart {
  ...
  compute() {
    return computeCart(
      ...
      { cartDiscountType: this.#cartDiscount.type, cartDiscountValue: this.#cartDiscount.value, taxes: this.#taxes },
    );
  }

  snapshot() {
    return { lines: this.#lines, customer: this.#customer, cartDiscount: this.#cartDiscount, totals: this.compute(), note: this.#note };
  }
