...
export function barcodeConfig(settings = {}) {
  return { ...DEFAULT_BARCODE, ...(settings.print?.barcode || {}), onePerPage: true };
}
...
export const SAMPLE_LABEL_ITEMS = [
  { name: 'Matte Lipstick — Ruby', brandName: 'Afia Beauty', sku: 'LIP-RUBY-01', barcode: '8901234500011', sellingPrice: 45000, mrp: 52000, costPrice: 26000, attributes: { color: 'Ruby', size: '3.5 g', variant: 'Matte' } },
  ...
  { name: 'Kajal Pencil Black', brandName: 'Afia Beauty', sku: 'KAJ-BLK', barcode: '8901234500035', sellingPrice: 18000, mrp: 20000, costPrice: 9000, attributes: { color: 'Black' } },
];
